...
int main(int argc, char* argv[])
{
    ...
    {
       if(TFS_SUCCESS != (ret= data_manager->read_raw_data(fileid,chunkid, offset, length,data_buffer)))
           break;
       if(TFS_SUCCESS != (ret=rfile.pwrite_file(data_buffer,length,offset)))
           break;
        offset += 1024;
    }
    rfile.close_file();
